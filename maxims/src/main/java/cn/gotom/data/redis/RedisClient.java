...
public class RedisClient implements RedissonClient {
	...
	public RedisClient(RedissonProperties redissonProperties, //
			RedisProperties redisProperties, //
			ConfigManager configManager) {
		this.redissonProperties = redissonProperties;
		this.redisProperties = redisProperties;
		configManager.global(DATAID, config -> setConfig(config));
	}
	...
	public void setConfig(String configInfo) {
		...
		if (reactiveStringRedisTemplate == null) {
			reactiveStringRedisTemplate = new ReactiveStringRedisTemplate(getConnectionFactory());
		}
	...
	@Override
	public RLock getSpinLock(String name, org.redisson.api.LockOptions.BackOff backOff) {
