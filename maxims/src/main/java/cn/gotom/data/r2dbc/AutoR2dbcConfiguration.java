...
import cn.gotom.data.UniversalManager;
import cn.gotom.data.UniversalManargeImpl;
import cn.gotom.data.dao.SimpleRepositoryFactory;
import cn.gotom.data.dao.UniversalDao;
import cn.gotom.data.dao.UniversalDaoImpl;
import cn.gotom.data.service.UniversalService;
import cn.gotom.data.service.UniversalServiceImpl;
...
public class AutoR2dbcConfiguration extends AbstractR2dbcConfiguration {
	...
	public SimpleRepositoryFactory simpleRepositoryFactory(R2dbcEntityTemplate databaseClient,
			DefaultReactiveDataAccessStrategy dataAccessStrategy) {
		return new SimpleRepositoryFactoryImpl(databaseClient, dataAccessStrategy);
	}
