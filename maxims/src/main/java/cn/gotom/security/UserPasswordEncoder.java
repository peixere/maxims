...
import cn.gotom.commons.utils.RandomStringUtils;
...
public class UserPasswordEncoder implements PasswordEncoder {
	...
	public void setDefault(Token user) {
		...
		if (user.getExpiresAt() == null) {
			user.setExpiresAt(DateTimeUtils.asLocalDateTime(DateTimeUtils.dateEnd(36500)));
		} else if (System.currentTimeMillis() >= DateTimeUtils.asDate(user.getExpiresAt()).getTime()) {
			user.setExpiresAt(DateTimeUtils.asLocalDateTime(DateTimeUtils.dateEnd(36500)));
		}
	}
