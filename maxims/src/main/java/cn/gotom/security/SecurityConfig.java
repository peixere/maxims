...
public class SecurityConfig {
	public final static String PAGE_INDEX = "/index.html";
	...
	@Bean
	public SecurityWebFilterChain springWebFilterChain(@Autowired ServerHttpSecurity http,
		...
		http.authorizeExchange()
				...
				.and().logout().logoutUrl(PAGE_LOGOUT).logoutSuccessHandler(handler)// 登出
